...
def main():
    archive_and_clear("bugs")
    archive_and_clear("crashes")
    os.makedirs("finalzrq3", exist_ok=True)
    mode = "remove_test"

    with open(f"finalzrq3/{mode}.csv", "w") as f:
        f.write("executed,interesting_tests\n")
    ...
    try:
        while True:
            ...
            if test_hash not in seen_hashes:
                ...
                test_corpus.append({"data": mutated, "history": test_history})
            ...
            if executed % 10 == 0:
                ...
                with open(f"finalzrq3/{mode}.csv", "a") as f:
                    f.write(f"{executed},{len(test_corpus)}\n")
